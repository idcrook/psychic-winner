/*
  ...
  iPhone 17 Pro Mechanical Mockups dummy model

  Modeled by David Crook - https://github.com/idcrook

  2025-Sep-09

  Thingiverse: https://www.thingiverse.com/thing:6311478

  Printables: https://www.printables.com/model/645469-iphone-15-pro-max-mechanical-mockup

  GitHub: https://github.com/idcrook/psychic-winner/tree/main/iphone_17_pro_mockup
...
DEVELOPING_iPhone_17_Pro_model = !false;
...
// R27, downloaded 2025-Sep-09
// 62. Device Dimensional Drawings
// iPhone dimensional drawings:
// ● iPhone 17 Pro, 1 of 4 (page 321)
// -	Height: 5.91 inches (150.01 mm)
// -	Width: 2.83 inches (71.85 mm)
// -	Depth: 0.34 inch (8.75 mm)

/// Gross iPhone 17 Pro dimensions
iphone_17_pro__height = 150.01;
iphone_17_pro__width  =  71.85;
iphone_17_pro__depth  =   8.75;
iphone_17_pro__z_mid  =   iphone_17_pro__depth / 2;

// Does our phone have a SIM slot?
SIM_SLOT_PRESENT = false;

// estimate
iphone_17_pro__face_corner_radius = 10.88; // very close to matching profile from blueprint

// iphone_17_pro__deep_blue = "#2C3143";
// iphone_17_pro__deep_blue_housing = "#23262E";
// iphone_17_pro__deep_blue_button = "#2F3340";
// iphone_17_pro__deep_blue_turret = iphone_17_pro__deep_blue;
// iphone_17_pro__deep_blue_plateau = "#282E3A";
// iphone_17_pro__deep_blue_lens_bezel = "#48506F";

iphone_17_pro__cosmic_orange = "#E67B34";
iphone_17_pro__cosmic_orange_housing = "#E67B34";
iphone_17_pro__cosmic_orange_button = "#E67B34";
iphone_17_pro__cosmic_orange_turret = iphone_17_pro__cosmic_orange;
iphone_17_pro__cosmic_orange_plateau = "#D88852";
iphone_17_pro__cosmic_orange_lens_bezel = "#D88852";
...
active_display__corner_r  = iphone_17_pro__face_corner_radius - active_display__inset_from_exterior;
...
usbc_connector__from_left = (iphone_17_pro__width - usbc_connector__from_right);
...
function translate_y_from_top (from_top)  = iphone_17_pro__height - from_top;
function translate_back_x_from_left (from_left)  = iphone_17_pro__width - from_left;
function translate_back_camera_depth (from_front)  = (iphone_17_pro__depth - from_front) ;
...
module iphone_17_pro (width, length, depth,
                      corner_radius = 7, show_keepouts = true)
{
  show_usbc_keepout = show_keepouts;

  w_to_ss = width - 2*housing__inset;
  l_to_ss = length - 2*housing__inset;

  // Housing housing goes all around with uniform inset
  translate([0,0,e])
    shell(width, length, depth-2*e,
          corner_radius, shell_color = iphone_17_pro__cosmic_orange, color_alpha = 0.95);

  // replace the housing shell at a uniform inset
  translate([housing__inset, housing__inset, 0])
    shell(w_to_ss, l_to_ss, depth, corner_radius - housing__inset, shell_color = iphone_17_pro__cosmic_orange,
          color_alpha = 0.92, full_size_pass = false);

  // Action button
  color(iphone_17_pro__cosmic_orange_button)
  ...
  // side button
  color(iphone_17_pro__cosmic_orange_button)
    translate([iphone_17_pro__width-e,
               translate_y_from_top(side_button__from_top),
               iphone_17_pro__z_mid]) {
    rotate([90,0,90])
  ...
  // rear camera module
  translate([iphone_17_pro__width, iphone_17_pro__height, 0])
    rotate([0, 180, 0])
    rear_camera(show_keepouts = show_keepouts);
  // front sensor bar module
  translate([0, iphone_17_pro__height, iphone_17_pro__depth])
    rotate([0, 0, 0])
...
edge_profile_b_polygon = concat([[1.15, iphone_17_pro__depth/2 + e], [0, iphone_17_pro__depth/2 + e], [0, 0]], edge_profile_b_set);
...
module test_face_profile() {
  translate([0,0,iphone_17_pro__depth/2]) {
    % face_profile_corner();
  }
}
...
module long_edge_profile() {
  ...
  union () {
      ...
      {
        rotate([-90,0,0])
          linear_extrude(height=iphone_17_pro__height)
          edge_profile_corner();
      }
    translate([0,iphone_17_pro__height,z_off_midline])
      {
        rotate([90,0,0])
          linear_extrude(height=iphone_17_pro__height)
          edge_profile_corner();
...
module edge_corner_profile() {
  ...
  union () {
      {
        translate([iphone_17_pro__face_corner_radius, iphone_17_pro__face_corner_radius, z_off_midline])
          rotate([0,0,-extra_angle_degrees])
          rotate_extrude(angle = rotate_angle)
          translate([-iphone_17_pro__face_corner_radius, 0])
          edge_profile_corner();
      }
      {
        translate([iphone_17_pro__face_corner_radius, iphone_17_pro__face_corner_radius, z_off_midline-0.05])
          rotate([0,0,-extra_angle_degrees])
          rotate_extrude(angle = rotate_angle)
          translate([-iphone_17_pro__face_corner_radius, 0])
          rotate([180,0,0])
...
module short_edge_profile() {
  ...
  translate([iphone_17_pro__width,0,0])
    rotate([0,0,90])
    union () {
    translate([0,0,z_off_midline-0.05])
      {
        rotate([-90,0,0])
          linear_extrude(height=iphone_17_pro__width)
          edge_profile_corner();
      }
    translate([0,iphone_17_pro__width,z_off_midline])
      {
        rotate([90,0,0])
          linear_extrude(height=iphone_17_pro__width)
          edge_profile_corner();
  ...
  // generate the basic solid outline
  {
    color(shell_color, alpha = color_alpha)
      ...
      if (full_size_pass) {
        ...
        // right side
        translate([iphone_17_pro__width + e, 0, 0]) mirror([1,0,0])  long_edge_profile();

        // bottom side
        translate([0, -e, 0]) short_edge_profile();
        // top side
        translate([0, iphone_17_pro__height + e, 0]) mirror([0,1,0])  short_edge_profile();

        // bottom left corner
        translate([-4*e, -4*e, 0]) edge_corner_profile();
        // bottom right corner
        translate([iphone_17_pro__width + 4*e, -4*e, 0]) mirror([1,0,0]) edge_corner_profile();
        // top left corner
        translate([-4*e, iphone_17_pro__height + 4*e, 0]) mirror([0,1,0]) edge_corner_profile();
        // top right corner
        translate([iphone_17_pro__width + 4*e, iphone_17_pro__height + 4*e, 0]) mirror([1,1,0]) edge_corner_profile();
      }
    }
...
module rear_camera (camera_plateau_height = rear_cam_plateau__z_height, show_keepouts = false) {
  ...
  %translate ([rear_cam_turret_center__from_left, -rear_cam_turret_center__from_top, -e])
    color(iphone_17_pro__cosmic_orange_turret, alpha = 0.70)
    difference()
    {
  ...
  translate ([rear_cam_turret_center__from_left, -rear_cam_turret_center__from_top, -e])
    color(iphone_17_pro__cosmic_orange_plateau, alpha = 0.70)
    difference() {
...
module rear_camera_lens(r, h = rear_cam_camera_glass__height, h_rim = rear_cam_camera_glass_rim__height,
  ...
  color(iphone_17_pro__cosmic_orange_lens_bezel, alpha=0.95)
...
echo ("corner_radius: ", iphone_17_pro__face_corner_radius);
...
if (DEVELOPING_iPhone_17_Pro_model)  {
  iphone_17_pro(iphone_17_pro__width, iphone_17_pro__height, iphone_17_pro__depth,
                iphone_17_pro__face_corner_radius,
                show_keepouts = true);
}
