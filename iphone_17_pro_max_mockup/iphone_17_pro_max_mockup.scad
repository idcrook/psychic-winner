/*
  ...
  iPhone 17 Pro Max Mechanical Mockups dummy model
  ...
  GitHub: https://github.com/idcrook/psychic-winner/tree/main/iphone_17_pro_max_mockup
...
DEVELOPING_iPhone_17_Pro_Max_model = !false;
...
// ● iPhone 17 Pro Max, 1 of 4 (page 317)
// -	Height: 6.43 inches (163.43 mm)
// -	Width: 3.07 inches (77.98 mm)
// -	Depth: 0.34 inch (8.75 mm)

/// Gross iPhone 17 Pro Max dimensions
iphone_17_pro_max__height = 163.43;
iphone_17_pro_max__width  =  77.98;
...
// estimate
iphone_17_pro_max__face_corner_radius = 10.88; // very close to matching profile from blueprint

// iphone_17_pro_max__deep_blue = "#2C3143";
// iphone_17_pro_max__deep_blue_housing = "#23262E";
// iphone_17_pro_max__deep_blue_button = "#2F3340";
// iphone_17_pro_max__deep_blue_turret = iphone_17_pro_max__deep_blue;
// iphone_17_pro_max__deep_blue_plateau = "#282E3A";
// iphone_17_pro_max__deep_blue_lens_bezel = "#48506F";

iphone_17_pro_max__cosmic_orange = "#E67B34";
...
module iphone_17_pro_max (width, length, depth,
                      corner_radius = 7, show_keepouts = true)
{
  ...
  translate([0,0,e])
    shell(width, length, depth-2*e,
          corner_radius, shell_color = iphone_17_pro_max__cosmic_orange, color_alpha = 0.95);

  // replace the housing shell at a uniform inset
  translate([housing__inset, housing__inset, 0])
    shell(w_to_ss, l_to_ss, depth, corner_radius - housing__inset, shell_color = iphone_17_pro_max__cosmic_orange,
  ...
  // rear camera module
  translate([iphone_17_pro_max__width, iphone_17_pro_max__height, 0])
    rotate([0, 180, 0])
    rear_camera(show_keepouts = show_keepouts);
  // front sensor bar module
  translate([0, iphone_17_pro_max__height, iphone_17_pro_max__depth])
    rotate([0, 0, 0])
...
module test_face_profile() {
  translate([0,0,iphone_17_pro_max__depth/2]) {
    % face_profile_corner();
  }
}
...
module edge_corner_profile() {
  ...
  union () {
      {
        translate([iphone_17_pro_max__face_corner_radius, iphone_17_pro_max__face_corner_radius, z_off_midline])
      ...
      {
        translate([iphone_17_pro_max__face_corner_radius, iphone_17_pro_max__face_corner_radius, z_off_midline-0.05])
          rotate([0,0,-extra_angle_degrees])
          rotate_extrude(angle = rotate_angle)
          translate([-iphone_17_pro_max__face_corner_radius, 0])
          rotate([180,0,0])
  ...
  // generate the basic solid outline
  {
    color(shell_color, alpha = color_alpha)
      ...
      if (full_size_pass) {
        ...
        // right side
        translate([iphone_17_pro_max__width + e, 0, 0]) mirror([1,0,0])  long_edge_profile();

        // bottom side
        translate([0, -e, 0]) short_edge_profile();
        // top side
        translate([0, iphone_17_pro_max__height + e, 0]) mirror([0,1,0])  short_edge_profile();

        // bottom left corner
        translate([-4*e, -4*e, 0]) edge_corner_profile();
        // bottom right corner
        translate([iphone_17_pro_max__width + 4*e, -4*e, 0]) mirror([1,0,0]) edge_corner_profile();
        // top left corner
        translate([-4*e, iphone_17_pro_max__height + 4*e, 0]) mirror([0,1,0]) edge_corner_profile();
        // top right corner
        translate([iphone_17_pro_max__width + 4*e, iphone_17_pro_max__height + 4*e, 0]) mirror([1,1,0]) edge_corner_profile();
      }
    }
...
module rear_camera (camera_plateau_height = rear_cam_plateau__z_height, show_keepouts = false) {
  ...
  %translate ([rear_cam_turret_center__from_left, -rear_cam_turret_center__from_top, -e])
    color(iphone_17_pro_max__cosmic_orange_turret, alpha = 0.70)
    difference()
    {
  ...
  translate ([rear_cam_turret_center__from_left, -rear_cam_turret_center__from_top, -e])
    color(iphone_17_pro_max__cosmic_orange_plateau, alpha = 0.70)
    difference() {
...
module rear_camera_lens(r, h = rear_cam_camera_glass__height, h_rim = rear_cam_camera_glass_rim__height,
  ...
  color(iphone_17_pro_max__cosmic_orange_lens_bezel, alpha=0.95)
...
echo ("corner_radius: ", iphone_17_pro_max__face_corner_radius);
...
if (DEVELOPING_iPhone_17_Pro_Max_model)  {
  iphone_17_pro_max(iphone_17_pro_max__width, iphone_17_pro_max__height, iphone_17_pro_max__depth,
                iphone_17_pro_max__face_corner_radius,
                show_keepouts = true);
}
