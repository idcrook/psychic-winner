...
// Description:
//
//   I decided to re-implement this iphone sleeve phone, to fit my iPhone X S
//   Plus case and using OpenSCAD
//
// Revisions/Notes:
//
//  02-Sep-2018 : speculatively preparing for new phone + case
//
////////////////////////////////////////////////////////////////////////
...
module sleeveForEncasediPhone (w, l, h, tweak_mount_surface, with_cap, with_sleeve) {
  ...
  CONTROL_RENDER_fingerprint_cutout = true;
  CONTROL_RENDER_fingerprint_cutout = false;
  ...
  bottomLipHeight = 4.5 + sleeveBaseThickness;
  ...
  intersection() {
	...
	difference() {
	  ...
	  // cutout for fingerprint sensor
	  //// wedge(height, radius, degrees);
      if ( CONTROL_RENDER_fingerprint_cutout) {
        ...
        translate([0, 0, bottomLipHeight-bottomLipCutout_h+e])
          ...
          // if not all the fingerprint/thumbprint area is removed, increase the first arg to wedge
          wedge (10 + 2, bottomLipCutoutArcRadius, bottomLipCutoutArcDegrees);
      }
    }
      }
